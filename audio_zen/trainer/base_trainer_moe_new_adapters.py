...
class BaseTrainer:
    ...
    def _preload_model(self, model_path):
        ...
        # import pdb; pdb.set_trace()
        model_checkpoint_012345_adapter2 = "/path/to/MultiChnSpeechFMExperiments/v4_SAT/SAT_to_fixed_array/array_012345/SAT_to_fixed_array_012345/checkpoints/best_model.tar"
        model_checkpoint_0246_adapter1 = "/path/to/MultiChnSpeechFMExperiments/v4_SAT/SAT_to_fixed_array/array_0246/SAT_to_fixed_array_0246/checkpoints/best_model.tar"
        model_checkpoint_0235_adapter0 = "/path/to/MultiChnSpeechFMExperiments/v4_SAT/SAT_to_fixed_array/array_0235/SAT_to_fixed_array_0235/checkpoints/best_model.tar"
        ...
        for k, v in self.model.module.state_dict().items():
            ...
            if fnmatch.fnmatch(k,"expert_adapter.*list.0*"):
                ...
                # import pdb; pdb.set_trace()
                updated_model_static_dict[k] = model_static_dict_adapter1[k]
                print(f"已替换: {k}")
            elif fnmatch.fnmatch(k,"expert_adapter.*list.2*"):
                # import pdb; pdb.set_trace()
                updated_model_static_dict[k] = model_static_dict_adapter2[k]
                print(f"已替换: {k}")
