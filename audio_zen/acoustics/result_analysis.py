...
class MultiChannelPerformance(object):
    def __init__(self, name):
        ...
        self.metric = ['SISNR', 'PESQ', 'SRMR', 'STOI']
...
#        self.load_info()
    ...
    def update_performance(self, wav_file, metric_result, ad, spk_num, spk_rt60, metric='SISNR'):
        doa_str = ''
 ...
 #           doa_str = 'no mix'
        ...
        if 0 <= spk_rt60 <= 0.26:
            spk_rt60_str = '0-0.33'
        elif 0.26 < spk_rt60 <= 0.38:
            spk_rt60_str = '0.33-0.66'
        elif spk_rt60 > 0.38:
            spk_rt60_str = '0.66-0.99' 
        ...
        if isinstance(metric_result, list):
            for result in metric_result:
                ...
                self.metrics[metric][spk_rt60_str].append(result)
                self.cnt += 1
            ...
            # import pdb; pdb.set_trace()
            self.metrics[metric][spk_rt60_str].append(metric_result)
